...
public class AuthUserService implements UserDetailsService {
    ...
    public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
        ...
        return User.builder().
                ...
                .authorities(new SimpleGrantedAuthority(user.getRole().name())).build();
    }
    ...
    public DataDto<SessionDto> login(AuthUserDto dto) {
        try {
            ...
            return new DataDto<>(new AppErrorDto("bad Request 1", " ", HttpStatus.BAD_REQUEST));

        }

        catch (IOException e) {

            return new DataDto<>(new AppErrorDto("bad request 2", "", HttpStatus.INTERNAL_SERVER_ERROR));
        }
...
//
    ...
    public DataDto<UploadsDto> getPicture(String path) throws NoSuchFileException {
        UploadsDto uploadsDto = fileStorageService.loadResource(path);
        return new DataDto<>(uploadsDto);
